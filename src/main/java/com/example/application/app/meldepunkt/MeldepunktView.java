...
@Route(value = "meldepunkte/:" + MeldepunktView.SAMPLEPERSON_ID + "?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class MeldepunktView extends Div implements BeforeEnterObserver, HasVeryDynamicTitle {
	 ...
	 * 
	 */
	public static final String SAMPLEPERSON_ID = "meldepunktID";
	...
	private BeanValidationBinder<Meldepunkt> binder = new BeanValidationBinder<>(Meldepunkt.class);
	...
	private void createEditorLayout(SplitLayout splitLayout) {
		...
		eigenschaften = new IntegerField("Eigenschaft");
